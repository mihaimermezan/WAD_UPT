...
public class EmailSender {
    public static final String ORIGIN_EMAIL = "mermezanmihai3@gmail.com";
    ...
    public static final String REGISTER_LINK = "http://localhost:4200/pc-register";
    public static final String LOGIN_LINK = "http://localhost:4200/login";
    public static final String TICKETS_MSG = "You have succesfully bought the ticket(s)!";
